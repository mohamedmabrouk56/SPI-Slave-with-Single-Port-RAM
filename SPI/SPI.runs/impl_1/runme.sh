...
HD_PWD='D:/Courses/Digital_Design_Diploma/Projects/2- SPI/SPI/SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_module.tcl -notrace
