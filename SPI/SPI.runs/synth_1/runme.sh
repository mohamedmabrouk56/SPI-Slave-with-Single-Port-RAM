...
HD_PWD='D:/Courses/Digital_Design_Diploma/Projects/2- SPI/SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_module.tcl
